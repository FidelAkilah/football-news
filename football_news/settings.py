...
SECRET_KEY = "django-insecure-92b$*)c!dp_vrs&5o&w7$56b*cebo8@8zu&!#or&qv(49!ch28"

PRODUCTION = os.getenv('PRODUCTION', 'False').lower() == 'true'
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "fidel-akilah-footballnews.pbp.cs.ui.ac.id","10.0.2.2"]
